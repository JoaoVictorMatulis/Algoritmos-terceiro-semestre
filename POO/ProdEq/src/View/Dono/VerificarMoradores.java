...
public class VerificarMoradores extends JFrame implements ActionListener{
    JPanel p1,p2;
    JLabel[] label;
    ...
    int coluna = 0;
    String[][] result;
    public VerificarMoradores(String[][] result) {
        this.result = result;
        label = new JLabel[result.length];
        setTitle("Verificar Moradores");
    ...
    private JPanel criarPainel(Color cor, GridLayout gl) {
